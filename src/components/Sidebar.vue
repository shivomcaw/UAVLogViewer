            ...
            <div class="menu-list">
                ...
                <div v-if="selected==='other'">
                    ...
                    <label v-if="state.logType==='tlog'" v-on:click="downloadTrimmed">
                        <i class="fa fa-download circle"
                        title="Download a log with starting and end time matching the current views"></i>
                        <a class="check-font"> Trimmed log </a>
                    </label>
                    <label>
                        <i class="fa fa-microchip circle"
                        title="Show a widget with the detected sensors"></i>
                ...
                <div v-if="state.files" class="show-hide">
                    ...
                    <li v-for="filename in Object.keys(state.files)"
                        :key="filename"
                        href="#"
